...
RELATORIO_TXT = (
    PASTA_RELATORIOS
    / "RELATORIO_DOWNLOAD_PRIORIDADE_C.txt"
)

RELATORIO_JSON = (
    PASTA_RELATORIOS
    / "RELATORIO_DOWNLOAD_PRIORIDADE_C.json"
)
...
def argumentos():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "as normas ausentes de Prioridade C."
        )
    )
...
def gerar_relatorio(
    ...
    linhas = [
        "LEX MACHINA",
        "DOWNLOAD AUTOMÁTICO - PRIORIDADE C",
        "=" * 78,
        "",
        f"GERADO EM: {agora()}",
        f"DESTINO: {destino}",
...
def main():
    ...
    print(
        "DOWNLOAD PRIORIDADE C FINALIZADO"
    )
